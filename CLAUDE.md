...
Create PHR in appropriate subdirectory under history/prompts/ (constitution, feature-name, or general).
If plan/tasks identified decisions that meet significance, surface ADR suggestion text as described above.
...
Auth Agent (auth-security-agent)
...
Frontend Agent (frontend-nextjs-optimizer)
...
Database Agent (neon-postgre-manager)
...
Backend Agent (fastapi-backend-manager)
